...
public class Partido {
	...
	public Inscripcion obtenerInscripcionDe(Jugador jugador)
	{
		...
		throw new RuntimeException("El jugador no est� inscripto en este partido.");
	}
	...
	{
		getMailSender().enviarMail(new Mail("Notificaci�n",mensaje,"","admin_partidos@dds.utn.frba"));
	}
